...
<body>
	...
	<div class="tab">
		...
		<div id="London" class="tabcontent">
		  <aside>
		    <?php 
		      require 'config.php';
		      $sql="SELECT * FROM `achievements` WHERE `achievements`.`achievements_grade` = 'A/L' ORDER BY `id` DESC";
	...
	<aside>
	    <?php 
	      require 'config.php';
	      $sql="SELECT * FROM `video_gellery` WHERE `video_gellery`.`video_grade` = 'A/L' ORDER BY `id` DESC";
	      $result = mysqli_query($conn,$sql);
	       ?>
