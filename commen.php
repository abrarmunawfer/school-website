...
<body>
	...
	<div class="tab">
		...
		<div id="London" class="tabcontent">
		  <aside>
		    <?php 
		      require 'config.php';
		      $sql="SELECT * FROM `achievements` WHERE `achievements`.`achievements_grade` = 'Commen' ORDER BY `id` DESC";
	...
	<div id="Paris" class="tabcontent">
	  <aside>
	    <?php 
	      require 'config.php';
	      $sql="SELECT * FROM `video_gellery` WHERE `video_gellery`.`video_grade` = 'Commen' ORDER BY `id` DESC";
	      $result = mysqli_query($conn,$sql);
	       ?>
