...
<body>
	...
	<aside id="main">
		...
		$result = mysqli_query($conn,$sql);
		 ?>
		<h3>Add Or Remove Contents of Anual Events</h3>
		<button class="button">
			<a href="add_event.php">Add Item</a>
		</button><br>
		<div class="content">
			<div class="row">
				<?php
		 		...
		 		<div class="card">
					...
					<div class="data-right">
						<button class="remove">
							<a style="text-decoration: none; color: #000" href="delete2.php?id=<?php echo $row['id'];?>">Remove</a>
						</button>
					</div>
			 	</div>
				<?php } ?>
