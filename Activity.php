...
<body>
			 	...
			 	<div class="row">
			 		...
			 		<div class="col-lg">
			 			<center>
			 				<div class="card">
			 				<div class="border">
			 					<h3 class="card-title"><?= $row['co_name'];?></h3><hr width="100%">
			 					<div class="divider">
			 						<div class="left">
			 							<center>
			 								<img src="<?= $row['co_logo'];?>" alt="Event Logo">
			 							</center>
	...
	<div id="Paris" class="tabcontent">
	  <aside>
	    <?php 
	      require 'config.php';
	      $sql="SELECT * FROM `video_gellery` WHERE `video_gellery`.`video_grade` = 'Co-Curriculum Activity' ORDER BY `id` DESC";
	      $result = mysqli_query($conn,$sql);
	       ?>
