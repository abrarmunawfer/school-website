...
<body>
	...
	<aside id="main">
		<?php 
		require 'config.php';
		$sql="SELECT * FROM `coactivity` ORDER BY `id` DESC";
		$result = mysqli_query($conn,$sql);
		 ?>
		<h3>Add Or Remove Contents of Co-Curriculum Activity</h3>
		<button class="button">
			<a href="add_activity.php">Add Item</a>
		</button><br>
		<div class="content">
			<div class="row">
				<?php
		 		...
		 		<div class="card">
		 			<div class="data-left">
						<h2><?= $row['co_name'];?></h2>
						<img src="<?= $row['co_logo'];?>" width=150px;>
					</div>
					<div class="data-right">
						<button class="remove">
							<a style="text-decoration: none; color: #000" href="delete4.php?id=<?php echo $row['id'];?>">Remove</a>
						</button>
					</div>
			 	</div>
				<?php } ?>
